          ...
          <div className="space-y-4 md:space-y-6">
            <div>
              ...
              <div className="space-y-3 md:space-y-4">
                <div>
                  <label className={`text-[11px] md:text-[12px] ${isDark ? 'text-[#888]' : 'text-gray-600'} mb-1 md:mb-2 block`}>Full Name</label>
                  <input
                    type="text"
                    ...
                    className={`w-full px-2 md:px-3 py-1.5 md:py-2 ${isDark ? 'bg-[#1f1f1f] border-white/10 text-white placeholder-[#555]' : 'bg-gray-50 border-gray-300 text-black placeholder-gray-500'} border rounded-lg text-[11px] md:text-[12px] focus:outline-none ${isDark ? 'focus:border-green-500' : 'focus:border-green-400'}`}
                  />
                </div>
                <div>
                  <label className={`text-[11px] md:text-[12px] ${isDark ? 'text-[#888]' : 'text-gray-600'} mb-1 md:mb-2 block`}>Email Address</label>
                  <input
                    type="email"
                ...
                <div>
                  <label className={`text-[11px] md:text-[12px] ${isDark ? 'text-[#888]' : 'text-gray-600'} mb-1 md:mb-2 block`}>Phone Number</label>
                  <input
                    type="tel"
        ...
        return (
          <div className="space-y-4 md:space-y-6">
            <div>
              ...
              <p className={`text-[10px] md:text-[12px] ${isDark ? 'text-[#888]' : 'text-gray-600'} mb-3 md:mb-4`}>Choose how your Rentra experience looks on this device</p>

              <div className="space-y-2 md:space-y-3">
                <label className={`flex items-center p-2 md:p-3 ${isDark ? 'border-white/10 hover:bg-[#1f1f1f]' : 'border-gray-300 hover:bg-gray-50'} border rounded-lg cursor-pointer transition-colors group`}>
                  <input
                    type="radio"
                    name="theme"
                    value="device"
                  ...
                  <div className="ml-2 md:ml-3 flex-1">
                    <div className="flex items-center gap-2">
                      <Monitor size={14} className={isDark ? 'text-[#555] group-hover:text-[#888]' : 'text-gray-500 group-hover:text-gray-700'} />
                      <span className={`text-[10px] md:text-[12px] font-medium ${isDark ? 'text-white' : 'text-black'}`}>Device Settings</span>
                    </div>
                    <p className={`text-[9px] md:text-[11px] ${isDark ? 'text-[#555]' : 'text-gray-500'} mt-1`}>
                ...
                <label className={`flex items-center p-2 md:p-3 ${isDark ? 'border-white/10 hover:bg-[#1f1f1f]' : 'border-gray-300 hover:bg-gray-50'} border rounded-lg cursor-pointer transition-colors group`}>
                  ...
                  <div className="ml-2 md:ml-3 flex-1">
                    <div className="flex items-center gap-2">
                      <Moon size={14} className={isDark ? 'text-[#555] group-hover:text-[#888]' : 'text-gray-500 group-hover:text-gray-700'} />
                ...
                <label className={`flex items-center p-2 md:p-3 ${isDark ? 'border-white/10 hover:bg-[#1f1f1f]' : 'border-gray-300 hover:bg-gray-50'} border rounded-lg cursor-pointer transition-colors group`}>
                  ...
                  <div className="ml-2 md:ml-3 flex-1">
                    <div className="flex items-center gap-2">
                      <Sun size={14} className={isDark ? 'text-[#555] group-hover:text-[#888]' : 'text-gray-500 group-hover:text-gray-700'} />
          ...
          <div className="space-y-4 md:space-y-6">
            <div>
              ...
              <div className="space-y-2 md:space-y-4">
                <label className={`flex items-center justify-between p-2 md:p-3 ${isDark ? 'border-white/10 hover:bg-[#1f1f1f]' : 'border-gray-300 hover:bg-gray-50'} border rounded-lg cursor-pointer transition-colors`}>
        ...
        return (
          <div className="space-y-4 md:space-y-6">
            <div>
              ...
              <div className="space-y-2 md:space-y-4">
                <div className={`p-2 md:p-4 ${isDark ? 'bg-[#1f1f1f] border-white/10' : 'bg-gray-50 border-gray-300'} border rounded-lg`}>
                  ...
                  <p className={`text-[9px] md:text-[11px] ${isDark ? 'text-[#555]' : 'text-gray-500'}`}>Keep your listings synchronized in real-time</p>
                </div>
                <div className={`p-2 md:p-4 ${isDark ? 'bg-[#1f1f1f] border-white/10' : 'bg-gray-50 border-gray-300'} border rounded-lg`}>
                  <div className="flex items-center justify-between mb-1 md:mb-2">
                  ...
                  <p className={`text-[9px] md:text-[11px] ${isDark ? 'text-[#555]' : 'text-gray-500'}`}>Automatically backup your settings and preferences</p>
                </div>
              </div>
            </div>
          </div>
        ...
        return (
          <div className="space-y-4 md:space-y-6">
            <div>
              ...
              <div className="space-y-2 md:space-y-3">
                <button className={`w-full p-2 md:p-3 text-left text-[10px] md:text-[12px] font-medium ${isDark ? 'text-white bg-[#1f1f1f] border-white/10 hover:bg-[#2a2a2a]' : 'text-black bg-gray-50 border-gray-300 hover:bg-gray-100'} border rounded-lg transition-colors`}>
                  Download Your Data
                </button>
                <button className={`w-full p-2 md:p-3 text-left text-[10px] md:text-[12px] font-medium ${isDark ? 'text-white bg-[#1f1f1f] border-white/10 hover:bg-[#2a2a2a]' : 'text-black bg-gray-50 border-gray-300 hover:bg-gray-100'} border rounded-lg transition-colors`}>
                  Deactivate Account
      ...
      <div className="pt-3 md:pt-6">
        <div className="max-w-6xl mx-auto px-3 md:px-6">
          <div className="mb-4 md:mb-8">
            ...
            <p className={`text-[11px] md:text-sm ${isDark ? 'text-[#888]' : 'text-gray-600'}`}>Manage your account preferences and security settings</p>
          </div>

          <div className="flex flex-col md:flex-row gap-3 md:gap-6">
            {/* Left Sidebar */}
            <div className="hidden md:block md:w-64 flex-shrink-0">
              <div className={`${isDark ? 'bg-[#171717] border-white/7' : 'bg-gray-50 border-gray-200'} rounded-lg border overflow-hidden sticky top-[100px] text-[11px] md:text-[12px]`}>
                <button
                ...
                {activeSection === 'account-preferences' && (
                  <div className={isDark ? 'bg-[#0f0f0f] border-white/7' : 'bg-white border-gray-200'}>
                    {[{ id: 'profile-info', label: 'Profile Information' }, { id: 'display', label: 'Display' }, { id: 'general', label: 'General Preferences' }, { id: 'syncing', label: 'Syncing Options' }, { id: 'account-management', label: 'Account Management' }].map((item) => (
                      <button key={item.id} onClick={() => setActiveSubMenu(item.id as AccountSubMenu)} className={`w-full text-left px-3 md:px-6 py-2 md:py-2.5 text-[9px] md:text-[11px] flex items-center justify-between transition-colors ${activeSubMenu === item.id ? isDark ? 'bg-green-500/10 text-green-400 font-medium' : 'bg-green-50 text-green-700 font-medium' : isDark ? 'text-[#888] hover:bg-[#1f1f1f]' : 'text-gray-700 hover:bg-gray-50'}`}>
                        {item.label}
                ...
                <button onClick={() => setActiveSection('notifications')} className={`w-full text-left px-2 md:px-4 py-2 md:py-3 text-[10px] md:text-[12px] font-mono tracking-widest transition-colors ${activeSection === 'notifications' ? isDark ? 'bg-green-500/10 text-green-400' : 'bg-green-50 text-green-700' : isDark ? 'text-[#555] hover:bg-[#1f1f1f]' : 'text-gray-600 hover:bg-gray-100'}`}>
                  NOTIFICATIONS
                </button>
              </div>
            </div>
            ...
            <div className="flex-1 w-full">
              {activeSection === 'account-preferences' && (
                <div className={`${isDark ? 'bg-[#171717] border-white/7' : 'bg-white border-gray-200'} rounded-lg border p-3 md:p-8`}>
              ...
              {activeSection === 'sign-in-security' && (
                <div className={`${isDark ? 'bg-[#171717] border-white/7' : 'bg-white border-gray-200'} rounded-lg border p-3 md:p-8`}>
                  ...
                  <div className="space-y-2 md:space-y-4">
                    <div className={`p-2 md:p-4 ${isDark ? 'bg-[#0f0f0f] border-white/10' : 'bg-gray-50 border-gray-200'} border rounded-lg`}>
                      <h4 className={`text-[10px] md:text-[12px] font-semibold ${isDark ? 'text-white' : 'text-black'} mb-1 md:mb-2`}>Change Password</h4>
                      <p className={`text-[9px] md:text-[11px] ${isDark ? 'text-[#555]' : 'text-gray-600'} mb-2 md:mb-3`}>Keep your account secure</p>
                    ...
                    <div className={`p-2 md:p-4 ${isDark ? 'bg-[#0f0f0f] border-white/10' : 'bg-gray-50 border-gray-200'} border rounded-lg`}>
                      ...
                      <p className={`text-[9px] md:text-[11px] ${isDark ? 'text-[#555]' : 'text-gray-600'} mb-2 md:mb-3`}>Add extra layer of security</p>
              ...
              {activeSection === 'data-privacy' && (
                <div className={`${isDark ? 'bg-[#171717] border-white/7' : 'bg-white border-gray-200'} rounded-lg border p-3 md:p-8`}>
                  ...
                  <div className="space-y-2 md:space-y-4">
                    <label className={`flex items-start gap-2 md:gap-3 p-2 md:p-4 ${isDark ? 'bg-[#0f0f0f] border-white/10 hover:bg-[#1f1f1f]' : 'bg-gray-50 border-gray-200 hover:bg-gray-100'} border rounded-lg cursor-pointer transition-colors`}>
                      ...
                      <div>
                        ...
                        <p className={`text-[9px] md:text-[11px] ${isDark ? 'text-[#555]' : 'text-gray-600'} mt-0.5 md:mt-1`}>Help us improve</p>
                      </div>
                    </label>
                  </div>
                </div>
              ...
              {activeSection === 'notifications' && (
                <div className={`${isDark ? 'bg-[#171717] border-white/7' : 'bg-white border-gray-200'} rounded-lg border p-3 md:p-8`}>
                  ...
                  <div className="space-y-2 md:space-y-3">
                    <label className={`flex items-center justify-between p-2 md:p-3 ${isDark ? 'bg-[#0f0f0f] border-white/10 hover:bg-[#1f1f1f]' : 'bg-gray-50 border-gray-200 hover:bg-gray-100'} border rounded-lg cursor-pointer transition-colors`}>
