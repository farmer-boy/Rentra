  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className={`text-[13px] ${isDark ? 'text-[#555]' : 'text-gray-500'}`}>Jhagra app ke andar solve karo — thane jaane ki zaroorat nahi</p>
      </div>
          ...
          <div className="space-y-3 mb-4">
            <div className={`p-4 border-l-3 border-red-500 rounded-lg ${isDark ? 'bg-[#3d0f0f]' : 'bg-red-50'}`}>
              <div className="flex justify-between mb-2">
                <span className={`text-[12px] font-bold ${isDark ? 'text-red-400' : 'text-red-700'}`}>Security Deposit Nahi Mili</span>
        ...
        <Card>
          ...
          <div className="h-56 bg-[#1f1f1f] rounded-lg p-3 mb-3 overflow-y-auto flex flex-col gap-2">
            <div className="text-[11px] bg-[#2a2a2a] rounded-lg p-2 max-w-xs">
              Maine ghar 31 Dec ko khali kar diya tha. Aapko deposit 2 hafte mein deni thi agreement ke mutabiq.
            </div>
            <div className="text-[11px] bg-green-500/10 text-green-400 rounded-lg p-2 max-w-xs ml-auto border border-green-500/20">
              Ghar mein damage tha. Maine repair karwaya — Rs 15,000 kharch hua.
            </div>
            <div className="text-[11px] bg-[#2a2a2a] rounded-lg p-2 max-w-xs">
              Damage ki koi proof nahi thi agreement mein. Main puri deposit maangta hon.
            </div>
            <div className="text-[10px] bg-yellow-500/10 text-yellow-400 border border-yellow-500/20 rounded-lg p-2 text-center">
              🤖 Platform Mediator: Dono parties se evidence maanga ja raha hai — 7 din mein submit karo
            </div>
          </div>
          <div className="flex gap-2">
            <input
