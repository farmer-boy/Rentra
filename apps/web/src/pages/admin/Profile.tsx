  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className={`text-[13px] ${isDark ? 'text-gray-700' : 'text-gray-600'}`}>Apni admin details dekho</p>
      </div>
      ...
      <Card>
        ...
        <div className={`flex gap-3 p-3 ${isDark ? 'bg-[#1f1f1f] border-white/10' : 'bg-gray-50'} border rounded-lg`}>
          ...
          <div>
            ...
            <div className={`text-[11px] ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>Manage system and moderation</div>
          </div>
        </div>
      </Card>
    </div>
