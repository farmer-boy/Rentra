...
const lightStyles = {
  ...
  ghost: 'bg-gray-100 text-gray-600 border border-gray-300 hover:text-gray-800 hover:bg-gray-200',
  danger: 'bg-red-100 text-red-700 border border-red-300 hover:bg-red-200',
};

const darkStyles = {
  primary: 'bg-green-500 text-black hover:bg-green-400',
  ghost: 'bg-[#1f1f1f] text-[#aaa] border border-white/10 hover:text-white hover:bg-[#2a2a2a]',
