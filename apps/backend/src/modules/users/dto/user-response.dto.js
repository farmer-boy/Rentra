...
exports.UserResponseDto = exports.Role = void 0;
...
let UserResponseDto = (() => {
    ...
    return _a = class UserResponseDto {
            constructor() {
                ...
                this.createdAt = (__runInitializers(this, _isSuspended_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
        ...
        (() => {
            ...
            _isVerified_decorators = [(0, swagger_1.ApiProperty)({ example: true })];
            _isSuspended_decorators = [(0, swagger_1.ApiProperty)({ example: false })];
            _createdAt_decorators = [(0, swagger_1.ApiProperty)({ example: '2024-01-15T10:30:00.000Z' })];
            _updatedAt_decorators = [(0, swagger_1.ApiProperty)({ example: '2024-01-15T10:30:00.000Z' })];
