...
let RegisterDto = (() => {
    ...
    return _a = class RegisterDto {
            constructor() {
                ...
                this.password = (__runInitializers(this, _cnic_extraInitializers), __runInitializers(this, _password_initializers, void 0));
        ...
        (() => {
            ...
            _phone_decorators = [(0, swagger_1.ApiProperty)({ example: '+923001234567' }), (0, class_validator_1.IsString)()];
            _cnic_decorators = [(0, swagger_1.ApiProperty)({ example: '35202-1234567-1' }), (0, class_validator_1.IsString)()];
