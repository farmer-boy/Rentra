...
let AgreementsService = (() => {
    ...
    let _classThis;
    var AgreementsService = _classThis = class {
        constructor(prisma) {
            this.prisma = prisma;
        }
        async create(tenantId, landlordId, listingId, rent, deposit, startDate, endDate) {
        ...
        async findById(id) {
            ...
            if (!agreement)
                throw new common_1.BadRequestException('Agreement nahi mila');
            return agreement;
        }
        async approve(id) {
    ...
    __setFunctionName(_classThis, "AgreementsService");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        AgreementsService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AgreementsService = _classThis;
})();
