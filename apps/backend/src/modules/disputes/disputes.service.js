...
let DisputesService = (() => {
    ...
    let _classThis;
    var DisputesService = _classThis = class {
        constructor(prisma) {
            this.prisma = prisma;
        }
        async create(tenantId, agreementId, title, description) {
        ...
        async findById(id) {
            ...
            if (!dispute)
                throw new common_1.BadRequestException('Dispute nahi mila');
            return dispute;
        }
    ...
    __setFunctionName(_classThis, "DisputesService");
    (() => {
