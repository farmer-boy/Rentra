    ...
    var ListingsService = _classThis = class {
        ...
        async update(id, landlordId, dto) {
            ...
            if (!listing || listing.landlordId !== landlordId) {
                throw new common_1.BadRequestException('Listing update nahi kar sakte');
            }
        ...
        async delete(id, landlordId) {
            const listing = await this.prisma.listing.findUnique({ where: { id } });
            if (!listing || listing.landlordId !== landlordId) {
                throw new common_1.BadRequestException('Listing delete nahi kar sakte');
            }
